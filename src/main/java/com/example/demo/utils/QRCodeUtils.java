...
public class QRCodeUtils {
	...
	private static BufferedImage createImage(String content, 
			String imgPath, boolean needCompress) throws Exception {
	...
	public static void encode(String content, 
			String imgPath, String destPath) throws Exception {
	 ...
	 */
	public static void encode(String content, 
			String imgPath, OutputStream output, 
	...
	public static void main(String[] args)  throws Exception {
		...
		//String text = "孕妇姓名:王二丫\n 身份证:331021193311010751\n 随访编号:第3次\n 标本简称: CBDNA\n 标本内容:儿童血液全血dna（紫色）"; 
		String text = "崔蔚华";
		String logoPath = "D:\\test\\332569.jpg";
